...
class MainViewModel : ViewModel() {
    ...
    fun retrieveData(userId: String) {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            try {
                data.value = ItemsApi.service.getItems(userId)
    ...
    fun deleteData(userId: String, id: String) {
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val result = ItemsApi.service.deleteItems(
                    userId,
                    id
                )
    ...
    fun saveData(userId: String, namaBarang: String, harga: String, bitmap: Bitmap){
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val result = ItemsApi.service.postItems(
                    userId,
